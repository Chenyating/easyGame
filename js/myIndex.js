var myIndex = new Vue({
    ...
    data: {
        ...
        skills:[
            {skill:"掌握前端基础HTML、CSS",master:"80%"},
            {skill:"熟悉javascript脚本语言：jquery库、vue",master:"75%"},
            {skill:"熟悉vue、vue-cli脚手架、拥有后台系统的前端开发经验",master:"60%"},
            {skill:"熟悉Bootstrap、iview前端样式框架",master:"70%"},
            {skill:"有小程序开发经验",master:"50%"},
            {skill:"熟练掌握PHOTOSHOP技术，拥有4年平面设计经验",master:"95%"},
        ],
        interface:0,
    },
    methods: {
